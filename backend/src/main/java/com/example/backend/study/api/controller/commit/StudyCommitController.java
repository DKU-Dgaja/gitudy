...
public class StudyCommitController {
    ...
    public ResponseEntity<CommitInfoResponse> commitDetails(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok().body(studyCommitService.getCommitDetailsById(commitId));
    }
    ...
    public ResponseEntity<List<CommitInfoResponse>> waitingCommitList(@AuthenticationPrincipal User user,
        ...
        return ResponseEntity.ok().body(studyCommitService.selectWaitingCommit(studyInfoId));
    }
